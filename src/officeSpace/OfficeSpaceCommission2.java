...
public class OfficeSpaceCommission2 {
    public static void main(String []args) {
        ...
        if (1501< officeSpace && officeSpace <= 2000) {
            leasingFee = leasingFee + 60;
        }

        else if (2001< officeSpace && officeSpace <= 2500) {
            leasingFee = leasingFee + 80;
        }

        else if (2501< officeSpace ) {
            leasingFee = leasingFee + 100;
        }
